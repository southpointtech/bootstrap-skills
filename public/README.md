...
- **21 custom skills** (`.agents/skills/`) — among them grill-me, grill-with-docs, tdd, to-prd, to-issues, triage, handoff, zoom-out, review-loop, slice-review (a local multi-agent code reviewer the agent can actually launch), verify-downstream-arrival, debug-source-first and a skills setup helper.

...
4. Tracker-ready task formatting
...
Technical issues live as local markdown in `.scratch/`. High-level tasks are registered in your issue tracker (GitHub Issues, Jira, Linear, …). See `docs/agents/issue-tracker.md`.

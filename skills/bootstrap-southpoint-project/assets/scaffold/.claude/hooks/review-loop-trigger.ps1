...
$msg = "You just closed a commit/slice on branch '$branch' (base '$base'). " +
       ...
       "Do not mark the work complete until the loop closes (zero medium/high-severity findings, or the turn cap: 2, or 1 if the commit declares 'Review-Rigor: light')."

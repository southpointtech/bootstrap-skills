...
description: Turn a decision you can't fully answer into a questionnaire for someone else to fill in. Use when a decision needs facts or judgement that only another person has, or the user says "armá un cuestionario", "preguntale esto a alguien" or "necesito que otro complete esto".
---

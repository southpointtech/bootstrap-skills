...
description: Writing documents for agents. Use when creating or editing skills, or modifying AGENTS.md or CLAUDE.md, or when the user says "escribí una skill", "mejorá esta skill", "revisá la description", "editá el CLAUDE.md", or "cómo le escribo esto a un agente".
---

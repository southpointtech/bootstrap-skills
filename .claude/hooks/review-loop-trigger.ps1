...
$msg = "Cerraste un commit/slice en el branch '$branch' (base '$base'). " +
       ...
       "No marques el trabajo como completo hasta que el loop cierre (cero hallazgos de severidad media/alta, o el tope de turnos: 2, o 1 si el commit declara 'Review-Rigor: light')."
